document.body.className = 'flex justify-center bg-gray-500';
const parent = document.createElement('div');
parent.className =
  'w-[600px] min-h-[100px] bg-white rounded-[10px] mt-[30px] flex flex-col items-center';
document.body.append(parent);
const inputBox = document.createElement('div');
inputBox.className =
  'w-[600px] h-[50px] m-[20px] flex justify-around text-blue-700 text-[20px]';
parent.append(inputBox);
const input = document.createElement('input');
input.className = 'w-[400px] h-[50px] bg-gray-300 rounded-[14px] pl-[20px]';
...
addBtn.addEventListener('click', () => {
  ...
  if (newText !== '') {
    ...
    list.className =
      'w-full min-h-[50px] bg-gray-300 rounded-[20px] p-[10px] flex items-center justify-between';
